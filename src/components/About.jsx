  ...
  return (
    <>
      ...
      <motion.p className='mt-4 text-secondary text-[17px] max-w-3xl leading-[30px]' variants={fadeIn("","",0.1,1)}>
          I'm a skilled software Developer in Javascript and i'm also an expert at React,Node.js and Three.js. 
          I'm a quick learner and I can collaborate effectively.
      </motion.p>
